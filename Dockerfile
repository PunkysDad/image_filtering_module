...
ARG STRIPE_SECRET_KEY=sk_test_buildtime_placeholder
ENV STRIPE_SECRET_KEY=${STRIPE_SECRET_KEY}
ARG NEXT_PUBLIC_SUPABASE_URL=https://placeholder.supabase.co
ENV NEXT_PUBLIC_SUPABASE_URL=${NEXT_PUBLIC_SUPABASE_URL}
ARG NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY=eyJplaceholder
ENV NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY=${NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY}
ARG NEXT_PUBLIC_STRIPE_BASIC_PRICE_ID=price_placeholder
ENV NEXT_PUBLIC_STRIPE_BASIC_PRICE_ID=${NEXT_PUBLIC_STRIPE_BASIC_PRICE_ID}
ARG NEXT_PUBLIC_STRIPE_PREMIUM_PRICE_ID=price_placeholder
